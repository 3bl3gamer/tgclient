...
const (
	...
	CRC_channel                                                           = 0x8261ac61
	CRC_channelForbidden                                                  = 0x17d493d5
	CRC_chatFull                                                          = 0xd18ee226
	CRC_channelFull                                                       = 0xea68a619
	...
	CRC_auth_authorization                                                = 0x33fb7bb8
	...
	CRC_inputPeerNotifySettings                                           = 0xdf1f002b
	CRC_peerNotifySettings                                                = 0xa83b0426
	...
	CRC_updateUserName                                                    = 0xc3f202e0
	CRC_updateUserPhoto                                                   = 0xf227868c
	...
	CRC_updateChannelReadMessagesContents                                 = 0x44bdd535
	...
	CRC_updateMessagePollVote                                             = 0x106395c9
	...
	CRC_updateMessageReactions                                            = 0x154798c3
	...
	CRC_account_password                                                  = 0x185b184f
	...
	CRC_messages_featuredStickers                                         = 0x84c02310
	...
	CRC_payments_paymentForm                                              = 0xb0133b37
	...
	CRC_channelAdminLogEventActionParticipantJoinByInvite                 = 0x5cdada77
	...
	CRC_channelAdminLogEventActionChangeAvailableReactions                = 0x9cf7f76a
	...
	CRC_codeSettings                                                      = 0x8a6469c2
	CRC_wallPaperSettings                                                 = 0x1dc1bca4
	CRC_autoDownloadSettings                                              = 0x8efab953
	...
	CRC_messageUserVote                                                   = 0x34d247b4
	CRC_messageUserVoteInputOption                                        = 0x3ca5b0ec
	CRC_messageUserVoteMultiple                                           = 0x8a65e557
	...
	CRC_sponsoredMessage                                                  = 0x3a836df8
	CRC_messages_sponsoredMessages                                        = 0x65a4c7d5
	...
	CRC_messages_translateNoResult                                        = 0x67ca4737
	CRC_messages_translateResultText                                      = 0xa214f7d0
	CRC_messagePeerReaction                                               = 0x51b67eff
	...
	CRC_help_premiumPromo                                                 = 0x8a4f3c29
	...
	CRC_contacts_block                                                    = 0x68cc1411
	CRC_contacts_unblock                                                  = 0xbea65d50
	...
	CRC_messages_sendMessage                                              = 0x0d9d75a4
	CRC_messages_sendMedia                                                = 0xe25ff8e0
	CRC_messages_forwardMessages                                          = 0xcc30290b
	...
	CRC_messages_sendInlineBotResult                                      = 0x7aa11297
	...
	CRC_messages_getAllChats                                              = 0x875f74be
	...
	CRC_messages_sendMultiMedia                                           = 0xf803138f
	...
	CRC_messages_getMessageReadParticipants                               = 0x2c6f97b7
	...
	CRC_messages_sendReaction                                             = 0x25690ce4
	CRC_messages_getMessagesReactions                                     = 0x8bba90e6
	CRC_messages_getMessageReactionsList                                  = 0xe0ee6b77
	CRC_messages_setChatAvailableReactions                                = 0x14050ea6
	CRC_messages_getAvailableReactions                                    = 0x18dea0ac
	CRC_messages_setDefaultReaction                                       = 0xd960c4d4
	CRC_messages_translateText                                            = 0x24ce6dee
	CRC_messages_getUnreadReactions                                       = 0xe85bae1a
	CRC_messages_readReactions                                            = 0x82e251d7
	CRC_messages_searchSentMedia                                          = 0x107e31a0
	CRC_messages_getAttachMenuBots                                        = 0x16fcc2cb
	CRC_messages_getAttachMenuBot                                         = 0x77216192
	CRC_messages_toggleBotInAttachMenu                                    = 0x1aee33af
	CRC_messages_requestWebView                                           = 0x91b15831
	CRC_messages_prolongWebView                                           = 0xea5fbcce
	CRC_messages_requestSimpleWebView                                     = 0x6abb2f73
	...
	CRC_payments_assignAppStoreTransaction                                = 0x0fec13c6
	CRC_payments_assignPlayMarketTransaction                              = 0x4faa4aed
	CRC_payments_restorePlayMarketReceipt                                 = 0xd164e36a
	CRC_payments_canPurchasePremium                                       = 0xaa6a90c8
	CRC_payments_requestRecurringPayment                                  = 0x146e958d
...
type TL_inputGroupCallStream struct {
	...
	TimeMs       int64
	Scale        int32
	VideoChannel int32 //flag
	VideoQuality int32 //flag
}
...
type TL_user struct {
	...
	Fake                 bool //flag
	BotAttachMenu        bool //flag
	Premium              bool //flag
	AttachMenuEnabled    bool //flag
	ID                   int64
...
type TL_channel struct {
	...
	Gigagroup           bool //flag
	Noforwards          bool //flag
	JoinToSend          bool //flag
	JoinRequest         bool //flag
	ID                  int64
	AccessHash          int64 //flag
	Title               string
	Username            string //flag
...
type TL_chatFull struct {
	...
	TtlPeriod              int32    //flag
	GroupcallDefaultJoinAs TL       // Peer //flag
	ThemeEmoticon          string   //flag
	RequestsPending        int32    //flag
	RecentRequesters       []int64  //flag
	AvailableReactions     []string //flag
}
...
type TL_channelFull struct {
	...
	Blocked                bool //flag
	Flags2                 int32
	CanDeleteChannel       TL // flags2_0?true
	ID                     int64
	About                  string
	ParticipantsCount      int32 //flag
	...
	Call                   TL       // InputGroupCall //flag
	TtlPeriod              int32    //flag
	PendingSuggestions     []string //flag
	GroupcallDefaultJoinAs TL       // Peer //flag
	ThemeEmoticon          string   //flag
	RequestsPending        int32    //flag
	RecentRequesters       []int64  //flag
	DefaultSendAs          TL       // Peer //flag
	AvailableReactions     []string //flag
}
...
type TL_message struct {
	...
	Reactions         TL     // MessageReactions //flag
	RestrictionReason []TL   // RestrictionReason //flag
	TtlPeriod         int32  //flag
}
...
type TL_messageActionPaymentSentMe struct {
	Flags            int32
	RecurringInit    bool //flag
	RecurringUsed    bool //flag
	Currency         string
	TotalAmount      int64
	Payload          []byte
...
type TL_auth_authorization struct {
	Flags                 int32
	SetupPasswordRequired bool  //flag
	OtherwiseReloginDays  int32 //flag
...
type TL_inputPeerNotifySettings struct {
	...
	Sound        TL    // NotificationSound //flag
}
...
type TL_peerNotifySettings struct {
	...
	Silent       TL    // Bool //flag
	MuteUntil    int32 //flag
	IosSound     TL    // NotificationSound //flag
	AndroidSound TL    // NotificationSound //flag
	OtherSound   TL    // NotificationSound //flag
}
...
type TL_peerSettings struct {
	...
	RequestChatBroadcast  bool   //flag
	GeoDistance           int32  //flag
	RequestChatTitle      string //flag
	RequestChatDate       int32  //flag
}
...
type TL_userFull struct {
	...
	TtlPeriod               int32  //flag
	ThemeEmoticon           string //flag
	PrivateForwardName      string //flag
	BotGroupAdminRights     TL     // ChatAdminRights //flag
	BotBroadcastAdminRights TL     // ChatAdminRights //flag
}
...
type TL_updateChatParticipant struct {
	...
	ActorID         int64
	UserID          int64
	PrevParticipant TL // ChatParticipant //flag
	NewParticipant  TL // ChatParticipant //flag
	Invite          TL // ExportedChatInvite //flag
	Qts             int32
}
...
type TL_authorization struct {
	...
	EncryptedRequestsDisabled bool //flag
	CallRequestsDisabled      bool //flag
	Hash                      int64
	DeviceModel               string
	Platform                  string
...
type TL_botInfo struct {
	...
	UserID              int64  //flag
	Description         string //flag
	DescriptionPhoto    TL     // Photo //flag
	DescriptionDocument TL     // Document //flag
	Commands            []TL   // BotCommand //flag
	MenuButton          TL     // BotMenuButton //flag
}
...
type TL_channelAdminLogEventActionExportedInviteEdit struct {
	PrevInvite TL // ExportedChatInvite
	NewInvite  TL // ExportedChatInvite
}
...
type TL_codeSettings struct {
	...
	AllowMissedCall bool //flag
	LogoutTokens    []TL // bytes //flag
}
...
type TL_inputThemeSettings struct {
	Flags                 int32
	MessageColorsAnimated bool //flag
	BaseTheme             TL   // BaseTheme
	AccentColor           int32
	OutboxAccentColor     int32   //flag
	MessageColors         []int32 //flag
...
type TL_groupCall struct {
	...
	RecordVideoActive       bool //flag
	RtmpStream              bool //flag
	ListenersHidden         bool //flag
	ID                      int64
	AccessHash              int64
	ParticipantsCount       int32
	Title                   string //flag
...
type TL_sponsoredMessage struct {
	Flags          int32
	Recommended    bool //flag
	RandomID       []byte
	FromID         TL     // Peer //flag
	ChatInvite     TL     // ChatInvite //flag
	ChatInviteHash string //flag
	ChannelPost    int32  //flag
	StartParam     string //flag
	Message        string
	Entities       []TL // MessageEntity //flag
...
type TL_messageReactions struct {
	Flags           int32
	Min             bool //flag
	CanSeeList      bool //flag
	Results         []TL // ReactionCount
	RecentReactions []TL // MessagePeerReaction //flag
}
...
type TL_availableReaction struct {
	...
	Reaction          string
	Title             string
	StaticIcon        TL // Document
	AppearAnimation   TL // Document
	SelectAnimation   TL // Document
	ActivateAnimation TL // Document
	EffectAnimation   TL // Document
	AroundAnimation   TL // Document //flag
	CenterIcon        TL // Document //flag
}
...
type TL_messages_translateNoResult struct {
}

type TL_messages_translateResultText struct {
	Text string
}
...
type TL_attachMenuBotIcon struct {
	...
	Name   string
	Icon   TL   // Document
	Colors []TL // AttachMenuBotIconColor //flag
}

type TL_attachMenuBot struct {
	Flags       int32
	Inactive    bool //flag
	HasSettings bool //flag
	BotID       int64
	ShortName   string
	PeerTypes   []TL // AttachMenuPeerType
...
type TL_help_premiumPromo struct {
	StatusText     string
	StatusEntities []TL // MessageEntity
...
type TL_auth_recoverPassword struct {
	Flags       int32
	Code        string
	NewSettings TL // account_PasswordInputSettings //flag
}
...
type TL_account_changeAuthorizationSettings struct {
	Flags                     int32
	Hash                      int64
	EncryptedRequestsDisabled TL // Bool //flag
	CallRequestsDisabled      TL // Bool //flag
}
...
type TL_messages_forwardMessages struct {
	...
	DropAuthor        bool //flag
	DropMediaCaptions bool //flag
	Noforwards        bool //flag
...
type TL_messages_exportChatInvite struct {
	Flags                 int32
	LegacyRevokePermanent bool   //flag
	RequestNeeded         bool   //flag
	Peer                  TL     // InputPeer
	ExpireDate            int32  //flag
	UsageLimit            int32  //flag
...
type TL_messages_getExportedChatInvites struct {
	...
	Revoked    bool   //flag
	Peer       TL     // InputPeer
	AdminID    TL     // InputUser
	OffsetDate int32  //flag
	OffsetLink string //flag
	Limit      int32
}
...
type TL_payments_restorePlayMarketReceipt struct {
	Receipt []byte
}
...
type TL_payments_requestRecurringPayment struct {
	UserID              TL // InputUser
...
func (e TL_chatFull) encode() []byte {
	...
	if e.Flags&32768 != 0 {
		x.Bytes(e.GroupcallDefaultJoinAs.encode())
	}
	if e.Flags&65536 != 0 {
	...
	if e.Flags&262144 != 0 {
		x.VectorString(e.AvailableReactions)
	}
	return x.buf
}
...
func (e TL_channelFull) encode() []byte {
	...
	//flag Blocked
	x.Int(e.Flags2)
	x.Bytes(e.CanDeleteChannel.encode())
	x.Long(e.ID)
	x.String(e.About)
	if e.Flags&1 != 0 {
		x.Int(e.ParticipantsCount)
	...
	if e.Flags&16777216 != 0 {
		x.Int(e.TtlPeriod)
	}
	if e.Flags&33554432 != 0 {
		x.VectorString(e.PendingSuggestions)
	}
	if e.Flags&67108864 != 0 {
		x.Bytes(e.GroupcallDefaultJoinAs.encode())
	}
	if e.Flags&134217728 != 0 {
		x.String(e.ThemeEmoticon)
	}
	if e.Flags&268435456 != 0 {
		x.Int(e.RequestsPending)
	}
	if e.Flags&268435456 != 0 {
		x.VectorLong(e.RecentRequesters)
	}
	if e.Flags&536870912 != 0 {
		x.Bytes(e.DefaultSendAs.encode())
	}
	if e.Flags&1073741824 != 0 {
		x.VectorString(e.AvailableReactions)
	}
	return x.buf
}
...
func (e TL_peerNotifySettings) encode() []byte {
	...
	if e.Flags&8 != 0 {
		x.Bytes(e.IosSound.encode())
	}
	if e.Flags&16 != 0 {
		x.Bytes(e.AndroidSound.encode())
	}
	if e.Flags&32 != 0 {
		x.Bytes(e.OtherSound.encode())
	}
	return x.buf
}
...
func (e TL_userFull) encode() []byte {
	...
	if e.Flags&131072 != 0 {
		x.Bytes(e.BotGroupAdminRights.encode())
	}
	if e.Flags&262144 != 0 {
		x.Bytes(e.BotBroadcastAdminRights.encode())
	}
	return x.buf
}
...
func (e TL_authorization) encode() []byte {
	...
	//flag EncryptedRequestsDisabled
	//flag CallRequestsDisabled
	x.Long(e.Hash)
...
func (e TL_botInfo) encode() []byte {
	...
	if e.Flags&16 != 0 {
		x.Bytes(e.DescriptionPhoto.encode())
	}
	if e.Flags&32 != 0 {
		x.Bytes(e.DescriptionDocument.encode())
	}
	if e.Flags&4 != 0 {
		x.Vector(e.Commands)
	}
	if e.Flags&8 != 0 {
		x.Bytes(e.MenuButton.encode())
	}
	return x.buf
}
...
func (e TL_channelAdminLogEventActionExportedInviteEdit) encode() []byte {
	...
	x.Bytes(e.PrevInvite.encode())
	x.Bytes(e.NewInvite.encode())
	return x.buf
}
...
func (e TL_codeSettings) encode() []byte {
	...
	//flag CurrentNumber
	//flag AllowAppHash
	//flag AllowMissedCall
	if e.Flags&64 != 0 {
		x.Vector(e.LogoutTokens)
	}
	return x.buf
}
...
func (e TL_groupCall) encode() []byte {
	...
	//flag CanStartVideo
	//flag RecordVideoActive
	//flag RtmpStream
	//flag ListenersHidden
	x.Long(e.ID)
	x.Long(e.AccessHash)
	x.Int(e.ParticipantsCount)
	if e.Flags&8 != 0 {
...
func (e TL_availableReaction) encode() []byte {
	...
	x.String(e.Reaction)
	x.String(e.Title)
	x.Bytes(e.StaticIcon.encode())
	x.Bytes(e.AppearAnimation.encode())
	x.Bytes(e.SelectAnimation.encode())
	x.Bytes(e.ActivateAnimation.encode())
	x.Bytes(e.EffectAnimation.encode())
	if e.Flags&2 != 0 {
		x.Bytes(e.AroundAnimation.encode())
	}
	if e.Flags&2 != 0 {
		x.Bytes(e.CenterIcon.encode())
	}
	return x.buf
}
...
func (e TL_messages_translateNoResult) encode() []byte {
	x := NewEncodeBuf(512)
	x.UInt(CRC_messages_translateNoResult)
	return x.buf
}

func (e TL_messages_translateResultText) encode() []byte {
	x := NewEncodeBuf(512)
	x.UInt(CRC_messages_translateResultText)
	x.String(e.Text)
	return x.buf
}
...
func (e TL_account_changeAuthorizationSettings) encode() []byte {
	...
	x.Long(e.Hash)
	if e.Flags&1 != 0 {
		x.Bytes(e.EncryptedRequestsDisabled.encode())
	}
	if e.Flags&2 != 0 {
		x.Bytes(e.CallRequestsDisabled.encode())
	}
	return x.buf
}
...
func (e TL_messages_editExportedChatInvite) encode() []byte {
	...
	if e.Flags&8 != 0 {
		x.Bytes(e.RequestNeeded.encode())
	}
	if e.Flags&16 != 0 {
		x.String(e.Title)
	}
...
func (e TL_payments_assignPlayMarketTransaction) encode() []byte {
	...
	x.String(e.PurchaseToken)
	return x.buf
}

func (e TL_payments_restorePlayMarketReceipt) encode() []byte {
	x := NewEncodeBuf(512)
	x.UInt(CRC_payments_restorePlayMarketReceipt)
	x.StringBytes(e.Receipt)
	return x.buf
}
...
func (e TL_payments_requestRecurringPayment) encode() []byte {
	x := NewEncodeBuf(512)
	x.UInt(CRC_payments_requestRecurringPayment)
	x.Bytes(e.UserID.encode())
	x.String(e.RecurringInitCharge)
	x.Bytes(e.InvoiceMedia.encode())
	return x.buf
}
...
func (e TL_phone_toggleGroupCallRecord) encode() []byte {
	...
	if e.Flags&4 != 0 {
		x.Bytes(e.VideoPortrait.encode())
	}
	return x.buf
}
...
func (e TL_inputGroupCallStream) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_messageActionSetMessagesTTL) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_messageActionSetChatTheme) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageActionChatJoinedByRequest) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageActionWebViewDataSentMe) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageActionWebViewDataSent) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_inputReportReasonIllegalDrugs) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_inputReportReasonPersonalDetails) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_updateChannelMessageForwards) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateReadChannelDiscussionInbox) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateReadChannelDiscussionOutbox) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updatePeerBlocked) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_updatePeerHistoryTTL) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateChatParticipant) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateChannelParticipant) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_updateBotCommands) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updatePendingJoinRequests) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateBotChatInviteRequester) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateMessageReactions) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateAttachMenuBots) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateWebViewResultSent) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateBotMenuButton) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateSavedRingtones) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_updateTranscribedAudio) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_sendMessageChooseStickerAction) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_sendMessageEmojiInteraction) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_sendMessageEmojiInteractionSeen) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_chatInvitePublicJoinRequests) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_chatInvitePeek) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_inputStickerSetAnimatedEmojiAnimations) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_messages_stickerSetNotModified) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_inputKeyboardButtonUserProfile) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_keyboardButtonUserProfile) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_keyboardButtonWebView) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_keyboardButtonSimpleWebView) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_messageEntitySpoiler) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_auth_codeTypeMissedCall) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_auth_sentCodeTypeMissedCall) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_inputBotInlineMessageID64) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_phoneConnectionWebrtc) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_channelAdminLogEventActionParticipantJoinByInvite) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionExportedInviteDelete) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionExportedInviteRevoke) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionExportedInviteEdit) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionParticipantVolume) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionChangeHistoryTTL) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionParticipantJoinByRequest) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionToggleNoForwards) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionSendMessage) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channelAdminLogEventActionChangeAvailableReactions) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_dialogFilterDefault) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_statsGroupTopPoster) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_statsGroupTopAdmin) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_statsGroupTopInviter) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_stats_megagroupStats) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_globalPrivacySettings) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_help_countryCode) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_help_country) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_help_countriesListNotModified) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_help_countriesList) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageViews) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_messageViews) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_messageReplyHeader) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageReplies) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_chatInviteImporter) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_exportedChatInvites) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_exportedChatInvite) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_exportedChatInviteReplaced) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_chatInviteImporters) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_chatAdminWithInvites) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_chatAdminsWithInvites) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_checkedHistoryImportPeer) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_phone_joinAsPeers) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_account_resetPasswordFailedWait) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_resetPasswordRequestedWait) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_resetPasswordOk) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_sponsoredMessage) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_sponsoredMessages) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_searchResultsCalendarPeriod) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_searchResultsCalendar) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_searchResultPosition) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_searchResultsPositions) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_channels_sendAsPeers) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_users_userFull) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_peerSettings) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_auth_loggedOut) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_reactionCount) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messageReactions) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_messageReactionsList) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_availableReaction) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_availableReactionsNotModified) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_availableReactions) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_translateNoResult) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_translateResultText) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messagePeerReaction) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_groupCallStreamChannel) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_phone_groupCallStreamChannels) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_phone_groupCallStreamRtmpUrl) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBotIconColor) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBotIcon) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBot) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBotsNotModified) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBots) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuBotsBot) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_webViewResultUrl) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_simpleWebViewResultUrl) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_webViewMessageSent) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_botMenuButtonDefault) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_botMenuButtonCommands) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_botMenuButton) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_savedRingtonesNotModified) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_savedRingtones) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_notificationSoundDefault) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_notificationSoundNone) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_notificationSoundLocal) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_notificationSoundRingtone) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_savedRingtone) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_account_savedRingtoneConverted) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuPeerTypeSameBotPM) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuPeerTypeBotPM) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuPeerTypePM) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuPeerTypeChat) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_attachMenuPeerTypeBroadcast) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_inputInvoiceMessage) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_inputInvoiceSlug) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_payments_exportedInvoice) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_messages_transcribedAudio) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}

func (e TL_help_premiumPromo) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_payments_restorePlayMarketReceipt) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (e TL_payments_requestRecurringPayment) decodeResponse(dbuf *DecodeBuf) TL {
	return dbuf.Object()
}
...
func (m *DecodeBuf) ObjectGenerated(constructor uint32) (r TL) {
	...
	case CRC_user:
		...
		r = TL_user{
			...
			flags&134217728 != 0, //flag #27
			flags&268435456 != 0, //flag #28
			flags&536870912 != 0, //flag #29
			m.Long(),
	...
	case CRC_chatFull:
		...
		r = TL_chatFull{
			...
			m.FlaggedInt(flags, 17),
			m.FlaggedVectorLong(flags, 17),
			m.FlaggedVectorString(flags, 18),
		}
	...
	case CRC_channelFull:
		...
		r = TL_channelFull{
			...
			m.FlaggedInt(flags, 24),
			m.FlaggedVectorString(flags, 25),
			m.FlaggedObject(flags, 26),
			m.FlaggedString(flags, 27),
			m.FlaggedInt(flags, 28),
			m.FlaggedVectorLong(flags, 28),
			m.FlaggedObject(flags, 29),
			m.FlaggedVectorString(flags, 30),
		}
	...
	case CRC_message:
		...
		r = TL_message{
			...
			m.FlaggedObject(flags, 20),
			m.FlaggedVector(flags, 22),
			m.FlaggedInt(flags, 25),
		}
	...
	case CRC_userFull:
		...
		r = TL_userFull{
			...
			m.FlaggedInt(flags, 11),
			m.FlaggedInt(flags, 14),
			m.FlaggedString(flags, 15),
			m.FlaggedString(flags, 16),
			m.FlaggedObject(flags, 17),
			m.FlaggedObject(flags, 18),
		}
	...
	case CRC_messages_translateNoResult:
		r = TL_messages_translateNoResult{}

	case CRC_messages_translateResultText:
		r = TL_messages_translateResultText{
			m.String(),
		}
	...
	case CRC_payments_restorePlayMarketReceipt:
		r = TL_payments_restorePlayMarketReceipt{
			m.StringBytes(),
		}
	...
	case CRC_payments_requestRecurringPayment:
		r = TL_payments_requestRecurringPayment{
			m.Object(),
			m.String(),
			m.Object(),
		}
